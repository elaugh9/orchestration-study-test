...
var human_support_button = '<button id="human-support-btn" class="jspsych-btn" style="margin-left: 10px;">Human Support</button>';
...
var main_page = {
  ...
  html: function() {
    ...
    var html = `
      ...
      <div>
        <button id="jspsych-survey-html-form-next" class="jspsych-btn jspsych-survey-html-form-next">Submit</button>
...
document.addEventListener('click', function(e) {
  if (e.target && e.target.id === 'human-support-btn') {
    ...
    document.getElementById('correct-answer').innerHTML = `Correct answer: ${correctOption}`;
